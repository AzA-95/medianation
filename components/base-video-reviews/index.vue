		...
		<div class="container">
			...
			<div
				v-match-height="{
					...
					isEnabled: (window: Window) => window.innerWidth > 767,
				}"
				class="slider"
			>
					...
					>
						<div class="video">
							...
							<div
								...
								class="video__logo"
								:style="`
									--img-width: ${item.client.picture_params.width};
									--img-height: ${item.client.picture_params.height};
								`"
							>
								<img
									v-lazy
									:data-src="item.client.picture"
									alt="client logo"
								/>
							</div>
							<div
...
<script setup lang="ts">
	...
	const items = computed(() => {
		const items = props.data.video_reviews?.items;
