...
function A11y(e) {
	...
	function g(e) {
		...
		(a.pagination &&
			a.pagination.el &&
			(n === a.pagination.el || a.pagination.el.contains(e.target)) &&
			!e.target.matches(
			...
			a.navigation &&
				a.navigation.prevEl &&
				n === a.navigation.prevEl &&
				((a.isBeginning && !a.params.loop) || a.slidePrev(),
				a.isBeginning ? s(t.firstSlideMessage) : s(t.prevSlideMessage)),
			a.pagination &&
				n.matches(classesToSelector(a.params.pagination.bulletClass)) &&
				n.click());
	}
	function u() {
		return (
			a.pagination && a.pagination.bullets && a.pagination.bullets.length
		);
	}
	function E() {
	...
	const f = (e, a, t) => {
			r(e),
				'BUTTON' !== e.tagName &&
					(o(e, 'button'), e.addEventListener('keydown', g)),
				d(e, t),
				(function (e, a) {
					(e = makeElementsArray(e)).forEach((e) => {
		...
		h = () => {
			...
			e.itemRoleDescriptionMessage &&
				c(a.slides, e.itemRoleDescriptionMessage),
				e.slideRole && o(a.slides, e.slideRole);
			const t = a.slides.length;
			e.slideLabelMessage &&
				a.slides.forEach((n, i) => {
		...
		A = () => {
			...
			e.containerRoleDescriptionMessage &&
				c(t, e.containerRoleDescriptionMessage),
				e.containerMessage && d(t, e.containerMessage);
			const n = a.wrapperEl,
				s =
					e.id ||
					n.getAttribute('id') ||
			...
			var r;
			const l =
				a.params.autoplay && a.params.autoplay.enabled
					? 'off'
					: 'polite';
			var o;
			(o = s),
				makeElementsArray(n).forEach((e) => {
					e.setAttribute('id', o);
				}),
				(function (e, a) {
					(e = makeElementsArray(e)).forEach((e) => {
				...
				h();
			let { nextEl: p, prevEl: m } = a.navigation ? a.navigation : {};
			if (
				((p = makeElementsArray(p)),
				(m = makeElementsArray(m)),
				p && p.forEach((a) => f(a, s, e.nextSlideMessage)),
				m && m.forEach((a) => f(a, s, e.prevSlideMessage)),
				E())
			) {
	...
	n('beforeInit', () => {
		(i = createElement('span', a.params.a11y.notificationClass)),
		...
		n('fromEdge toEdge afterInit lock unlock', () => {
			a.params.a11y.enabled &&
				(function () {
					if (a.params.loop || a.params.rewind || !a.navigation)
						return;
					const { nextEl: e, prevEl: t } = a.navigation;
					t && (a.isBeginning ? (p(t), l(t)) : (m(t), r(t))),
						e && (a.isEnd ? (p(e), l(e)) : (m(e), r(e)));
				})();
		}),
		n('paginationUpdate', () => {
			a.params.a11y.enabled &&
					...
					u() &&
						a.pagination.bullets.forEach((t) => {
							a.params.pagination.clickable &&
								...
								t.matches(
									classesToSelector(
										a.params.pagination.bulletActiveClass,
									),
								)
