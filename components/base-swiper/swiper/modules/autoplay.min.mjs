...
function Autoplay(e) {
	...
	function w(e) {
		n &&
			...
			(n.wrapperEl.removeEventListener('transitionend', w), g || S());
	}
	const E = () => {
						...
						(n.params.autoplay.reverseDirection
							? !n.isBeginning || n.params.loop || n.params.rewind
								...
								: n.params.autoplay.stopOnLastSlide ||
									(n.slideTo(n.slides.length - 1, s, !0, !0),
									o('autoplay'))
		...
		A = () => {
			if (n.destroyed || !n.autoplay.running) return;
			const e = getDocument();
			'hidden' === e.visibilityState && ((c = !0), O(!0)),
				'visible' === e.visibilityState && S();
		},
		F = (e) => {
			'mouse' === e.pointerType &&
				((c = !0), (g = !0), n.animating || n.autoplay.paused || O(!0));
		},
		M = (e) => {
	...
	i('init', () => {
		...
		Object.assign(n.autoplay, { start: L, stop: D, pause: O, resume: S });
}
