...
function Thumb(e) {
	...
	function n() {
		...
		return (
			s.thumbs.swiper.el.classList.add(
				s.params.thumbs.thumbsContainerClass,
			),
	...
	function d(e) {
		...
		if (
			...
			for (let e = 0; e < r; e += 1)
				i.slides[s.realIndex + e] &&
					i.slides[s.realIndex + e].classList.add(a);
		...
		if (s.realIndex !== i.realIndex || n) {
			...
			if (i.params.loop) {
				...
				(a = s.realIndex), (d = a > s.previousIndex ? 'next' : 'prev');
			n && (a += 'next' === d ? l : -1 * l),
