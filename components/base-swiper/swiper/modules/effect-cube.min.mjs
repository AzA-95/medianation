	...
	effectInit({
		...
		setTranslate: () => {
			...
			if (
				...
				if (c)
					h.style.transform = `translate3d(0px, ${o / 2 + p.shadowOffset}px, ${-o / 2}px) rotateX(89.99deg) rotateZ(0deg) scale(${p.shadowScale})`;
				else {
			...
			const m =
				(n.isSafari || n.isWebView) && n.needPerspectiveFix
					? -d / 2
					: 0;
