...
!(function () {
	...
	function R(e) {
		...
		if ('touchstart' === a.type)
			return void H(t, a, a.targetTouches[0].pageX);
	...
	const me = [
		...
		function (e) {
			...
			function L(e) {
				...
				let a, r, l, o, d, c, u, g, v, b, E, S, T, M, C, P, L, z;
				t.params.cssMode &&
					((t.wrapperEl.style.overflow = 'hidden'),
			...
			const g = (e, t, s) => {
				...
				S = () => {
					...
					(o = r),
						...
						E();
					let { nextEl: c, prevEl: u } = t.navigation
						? t.navigation
						: {};
					if (
						((c = T(c)),
